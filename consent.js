...
(function () {
  ...
  var CATS = [
    ...
    { id: "marketing", name: "עוגיות שיווק ופרסום", locked: false, inUse: false,
      desc: "משמשות להתאמת מודעות באתרים אחרים ולמדידת יעילות קמפיינים, לרבות על ידי צדדים שלישיים." }
  ];
